...
vocabulary_file_to_use_in_transformers = "VocabularyTokenizer/EUROPARLvocabFROGMORPH.txt"
...
with open('TrainFiles/FrogPiece_europarl_sentences_ids_1000k_128seq.pickle', 'rb') as inputfile:
    europarl_sentences_ids_1000k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogPiece_europarl_sentences_ids_1000k_2000k_128seq.pickle', 'rb') as inputfile:
...
with open('TrainFiles/FrogPiece_oscar_sentences_ids_500k_128seq.pickle', 'rb') as inputfile:
    oscar_sentences_ids_500k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogPiece_oscar_sentences_ids_500k_1000k_128seq.pickle', 'rb') as inputfile:
    oscar_sentences_ids_500k_1000k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogPiece_oscar_sentences_ids_1000k_1500k_128seq.pickle', 'rb') as inputfile:
    oscar_sentences_ids_1000k_1500k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogPiece_oscar_sentences_ids_1500k_2000k_128seq.pickle', 'rb') as inputfile:
