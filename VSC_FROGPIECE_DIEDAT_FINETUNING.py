import torch
import transformersAdjusted
import numpy as np
from numpy import array, argmax
from transformers import BertTokenizer, BertForMaskedLM, BertForSequenceClassification, AutoModelForSequenceClassification, AutoConfig, AutoModel, AdamW, get_linear_schedule_with_warmup, DataCollatorForLanguageModeling, Trainer, TrainingArguments, EarlyStoppingCallback
...
vocabulary_file_to_use_in_transformers = "EUROPARLvocabFROGMORPH.txt"
...
with open('TrainFiles/FrogMerge_europarl_sentences_ids_1000k_128seq.pickle', 'rb') as inputfile:
    europarl_sentences_ids_1000k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogMerge_europarl_sentences_ids_1000k_2000k_128seq.pickle', 'rb') as inputfile:
...
with open('TrainFiles/FrogMerge_oscar_sentences_ids_500k_128seq.pickle', 'rb') as inputfile:
    oscar_sentences_ids_500k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogMerge_oscar_sentences_ids_500k_1000k_128seq.pickle', 'rb') as inputfile:
    oscar_sentences_ids_500k_1000k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogMerge_oscar_sentences_ids_1000k_1500k_128seq.pickle', 'rb') as inputfile:
    oscar_sentences_ids_1000k_1500k_128seq = pickle.load(inputfile)

with open('TrainFiles/FrogMerge_oscar_sentences_ids_1500k_2000k_128seq.pickle', 'rb') as inputfile:
...
MorphTokenizer_for_data_collator = tokenizer
...
#model = AutoModelForSequenceClassification.from_pretrained("./FrogMerge128")
model = BertForSequenceClassification.from_pretrained("./FrogMerge128", num_labels=2)
...
trainer.save_model("./FrogPiece128")
